...
class ConvertLoadbuildInstance(object):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--type', '-t', metavar='TYPE', choices=['json', 'yaml', 'xml', 'ortec'], help='The type of the input file')
    ...
    converter = ConvertLoadbuildInstance(args.input,args.type,args.setname,args.instancename)
